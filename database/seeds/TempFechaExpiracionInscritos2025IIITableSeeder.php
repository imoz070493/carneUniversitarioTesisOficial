...
class TempFechaExpiracionInscritos2025IIITableSeeder extends Seeder
{
    /**
    ...
    public static function data(){
        ...
        $json = File::get(database_path('data/fecha_expiracion_inscritos_2025_III.json'));
