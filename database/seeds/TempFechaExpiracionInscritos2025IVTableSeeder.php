...
class TempFechaExpiracionInscritos2025IVTableSeeder extends Seeder
{
    /**
    ...
    public static function data(){
        ...
        $json = File::get(database_path('data/fecha_expiracion_inscritos_2025_IV.json'));
