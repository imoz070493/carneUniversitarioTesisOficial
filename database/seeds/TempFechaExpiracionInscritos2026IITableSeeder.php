...
class TempFechaExpiracionInscritos2026IITableSeeder extends Seeder
{
    /**
    ...
    public static function data(){
        ...
        $json = File::get(database_path('data/fecha_expiracion_inscritos_2026_II.json'));
