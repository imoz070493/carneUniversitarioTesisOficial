<template>
    ...
    <v-listar-permiso ref="cmp_listado_permiso"></v-listar-permiso>
</template>
<script>
/**
...
const VListarPermiso = () => import("@/components/erp/permiso/ListarPermiso");

export default {
  components: {
    "v-listar-permiso": VListarPermiso,
  },
  data() {
    return {
      ruta: "venta"
