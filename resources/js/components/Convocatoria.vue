<template>
    ...
    <v-listar-convocatoria ref="cmp_listado_convocatoria"></v-listar-convocatoria>
</template>
<script>
/**
...
const VListarConvocatoria = () => import("@/components/erp/convocatoria/ListarConvocatoria");

export default {
  components: {
    "v-listar-convocatoria": VListarConvocatoria,
  },
  data() {
    return {
      ruta: "venta"
