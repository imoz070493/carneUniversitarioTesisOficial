<template>
    ...
    <v-listar-inscrito ref="cmp_listado_inscrito"></v-listar-inscrito>
</template>
<script>
/**
...
const VListarInscrito = () => import("@/components/erp/inscrito/ListarInscrito");

export default {
  components: {
    "v-listar-inscrito": VListarInscrito,
  },
  data() {
    return {
      ruta: "venta"
