<template>
    ...
    <v-listar-carga-matricula ref="cmp_listado_matricula"></v-listar-carga-matricula>
</template>
<script>
/**
...
const VListarCargaMatricula = () => import("@/components/erp/carga_matricula/ListarCargaMatricula");

export default {
  components: {
    "v-listar-carga-matricula": VListarCargaMatricula,
  },
  data() {
    return {
      ruta: "venta"
