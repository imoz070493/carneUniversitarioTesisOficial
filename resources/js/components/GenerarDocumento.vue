<template>
    ...
    <v-listar-generar-documento ref="cmp_listado_generar_documento"></v-listar-generar-documento>
</template>
<script>
/**
...
const VListarGenerarDocumento = () => import("@/components/erp/solicitud_documento/ListarGenerarDocumento");

export default {
  components: {
    "v-listar-generar-documento": VListarGenerarDocumento,
  },
  data() {
    return {
      ruta: "venta"
