            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="form-group">
                        ...
                        <input
                            type="text"
                            v-model="editable.correo_personal"
                            class="form-control"
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="form-group">
                        ...
                        <label v-if="editable.estado_tramite=='inscrito'" class="col-form-label"><span class="badge badge-success">Inscrito</span></label>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <img v-if="editable.foto_validado" id="image" width="240" height="288" v-bind:src="'/storage/'+editable.folder+'/1_validado/'+editable.foto"/>
                                <img v-else id="image" width="240" height="288" v-bind:src="'/storage/'+editable.folder+'/2_sin_validar/'+editable.foto"/>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <!-- <label><dt>Imagen:</dt></label> -->
                                <img id="image" width="240" height="288" v-bind:src="'/storage/'+editable.folder+'/4_vouchers/'+editable.foto"/>
                            </div>
                        </div>
                    </div>
                </div>
