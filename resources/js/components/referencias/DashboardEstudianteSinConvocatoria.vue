<template>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="row" v-for="convocatoria in array_convocatorias" :key="convocatoria.id">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="form-group">
                    <label><dt>Convocatoria: </dt></label><br>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="form-group">
                    <label><dt>Fecha Registro: </dt></label><br>
                    <span>{{convocatoria.fecha_registro}}</span>
                </div>
            </div>

            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="form-group">
                    <label><dt>N° Recibo: </dt></label><br>
                    <span>{{convocatoria.numero_recibo}}</span>
                </div>
            </div>

            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="form-group">
                    <label><dt>Fecha Expiración: </dt></label><br>
                    <span>{{convocatoria.fecha_expiracion}}</span>
                </div>
            </div>
        </div>
    </div>
