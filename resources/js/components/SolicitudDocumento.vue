<template>
    ...
    <v-listar-solicitud-documento ref="cmp_listado_solicitud_documento"></v-listar-solicitud-documento>
</template>
<script>
/**
...
const VListarSolicitudDocumento = () => import("@/components/erp/solicitud_documento/ListarSolicitudDocumento");

export default {
  components: {
    "v-listar-solicitud-documento": VListarSolicitudDocumento,
  },
  data() {
    return {
      ruta: "venta"
