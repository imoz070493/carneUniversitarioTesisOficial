<template>
    ...
    <v-listar-categoria ref="cmp_listado_categoria"></v-listar-categoria>
</template>
<script>
/**
...
const VListarCategoria = () => import("@/components/erp/categoria/ListarCategoria");

export default {
  components: {
    "v-listar-categoria": VListarCategoria,
  },
  data() {
    return {
      ruta: "venta"
