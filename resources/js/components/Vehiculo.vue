<template>
    ...
    <v-listar-vehiculo ref="cmp_listado_vehiculo"></v-listar-vehiculo>
</template>
<script>
/**
...
const VListarVehiculo = () => import("@/components/erp/vehiculo/ListarVehiculo");

export default {
  components: {
    "v-listar-vehiculo": VListarVehiculo,
  },
  data() {
    return {
      ruta: "venta"
