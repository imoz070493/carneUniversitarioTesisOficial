<template>
    ...
    <v-listar-ingreso ref="cmp_listado_ingreso"></v-listar-ingreso>
</template>
<script>
/**
...
const VListarIngreso = () => import("@/components/erp/ingreso/ListarIngreso");

export default {
  components: {
    "v-listar-ingreso": VListarIngreso,
  },
  data() {
    return {
      ruta: "venta"
