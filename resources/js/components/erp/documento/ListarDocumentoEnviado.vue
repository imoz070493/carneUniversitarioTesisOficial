<template>
        <main class="main">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Enviados</a></li>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr v-for="inscrito in arrayInscrito" :key="inscrito.id">
                                    <td>
                                        <div class="">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a v-if="inscrito.estado=='procesando'" class="dropdown-item" href="#" @click="enviarFacultad(inscrito)"><img src="images/editar.svg" style="width: 20px; height: 20px;"/>   Enviar a Facultad</a>
                                                <a v-if="inscrito.estado=='facultad'" class="dropdown-item" href="#" @click="recibirFacultad(inscrito)"><img src="images/editar.svg" style="width: 20px; height: 20px;"/>   Recibir</a>
                                    ...
                                    <td v-text="inscrito.carta"></td>
                                    <td v-text="inscrito.facultad"></td>
            ...
            <!-- Nuevo -->
            <v-formulario-documento-procesado 
...
const VerDocumentoEnviado = () => import("@/components/erp/documento/VerDocumentoEnviado");
...
export default {
    ...
    methods: {
        listarDocumentoEnvio(page, buscar, criterio){
            let me = this;
            // var url = '/documento_envio?page='+page+'&buscar='+buscar+'&criterio='+criterio+'&per_page='+this.per_page;
