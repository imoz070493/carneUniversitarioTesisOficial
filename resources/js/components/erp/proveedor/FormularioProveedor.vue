        ...
        <div class="modal-dialog modal-primary modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" v-if="var_config.tipo_accion=='registrar'" class="btn btn-primary" :disabled="btn.registrar" @click="registrarProveedor()">Guardar</button>
                    <button type="button" v-if="var_config.tipo_accion=='actualizar'" class="btn btn-primary" :disabled="btn.actualizar" @click="actualizarProveedor()">Actualizar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
export default {
    ...
    methods: {
        registrarProveedor(){
            ...
            axios.post('/proveedor/registrar',this.editable).then(function (response){
                me.$emit('guardado');
                me.cerrarModal();
            })
            .catch(error => {
        ...
        actualizarProveedor(){
            ...
            axios.put('/proveedor/actualizar',this.editable).then(function (response){
                me.$emit('guardado');
                me.cerrarModal();
            })
            .catch(error => {
