                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-model="editable.nombre" class="form-control" placeholder="Nombre de marca">
...
export default {
  ...
  methods: {
        registrarCategoria(){
            ...
            axios.post('/marca/registrar',this.editable).then(function (response){
                me.$emit('guardado');
                me.cerrarModal();
            })
            .catch(error => {
        ...
        actualizarCategoria(){
            ...
            axios.put('/marca/actualizar',this.editable).then(function (response){
                me.$emit('guardado');
                me.cerrarModal();
            })
            .catch(error => {
