<template>
        <main class="main">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-if="show.arrayUsuario"><th colspan="2" class="text-center text-dark" v-text="'Vacio'"></th></tr>
                                <tr v-for="usuario in arrayUsuario" :key="usuario.id">
                                    <td>
                                        <button type="button" @click="editar(usuario)" class="btn btn-warning btn-sm">
                                        ...
                                        <template v-else-if="usuario.estado=='inactivo'">
                                    ...
                                    <td v-text="formatRoles(usuario.roles)"></td>
                                    <td>
                                        <div v-if="usuario.estado=='activo'">
                                            <span class="badge badge-success">Activo</span>
                                        </div>
                                        <div v-else-if="usuario.estado=='inactivo'">
            ...
            <!-- Nuevo -->
            <v-formulario-usuario 
                v-if="nuevo._estado=='creando'" 
                v-model="nuevo"
                ref="cmp_crear_usuario"
                :var_config="var_config"
                @guardado="listarUsuario(1, '', 'nombre')"
            ></v-formulario-usuario>
...
const FormularioUsuario = () => import("@/components/erp/usuario/FormularioUsuario");
    ...
    methods: {
        listarUsuario(page, buscar, criterio){
            ...
            axios.get(url).then(function (response){
                ...
                if(me.arrayUsuario.length==0) me.show['arrayUsuario'] = true;
                else me.show['arrayUsuario'] = false;
            })
