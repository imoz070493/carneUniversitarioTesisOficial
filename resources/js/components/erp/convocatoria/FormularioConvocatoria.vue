        ...
        <div class="modal-dialog modal-primary modal-lg">
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" v-model="editable.nombre" class="form-control" placeholder="Convocatoria...">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" v-if="var_config.tipo_accion=='registrar'" class="btn btn-primary" :disabled="btn.registrar" @click="registrarConvocatoria()">Guardar</button>
                    <button type="button" v-if="var_config.tipo_accion=='actualizar'" class="btn btn-primary" :disabled="btn.actualizar" @click="actualizarConvocatoria()">Actualizar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
