                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group pull-right">
                                            ...
                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                <input type="checkbox" v-model="editable._duplicado" class="custom-control-input" id="customSwitch7" @change="changeDuplicado($event)" :disabled="lock._duplicado">
                                                <label style="width:70px;" class="custom-control-label" for="customSwitch7" v-html="text._duplicado"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group pull-right">
                                            ...
                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                <input type="checkbox" v-model="editable._foto_validado" class="custom-control-input" id="customSwitch8" @change="changeTipo($event)" :disabled="lock._foto_validado">
                                                <label style="width:70px;" class="custom-control-label" for="customSwitch8" v-html="text._foto_validado"></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea 
                                                type="text" 
                                                v-model="editable.observacion"
                                                class="form-control"
                                                placeholder="Observacion..."
                                                :disabled="lock.observacion"
                                            ></textarea>
