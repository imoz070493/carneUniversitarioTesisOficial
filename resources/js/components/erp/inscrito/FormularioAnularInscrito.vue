                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group pull-right">
                                            ...
                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                <input type="checkbox" v-model="editable._duplicado" class="custom-control-input" id="customSwitch9" @change="changeDuplicado($event)" :disabled="lock._duplicado">
                                                <label style="width:70px;" class="custom-control-label" for="customSwitch9" v-html="text._duplicado"></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group pull-right">
                                            ...
                                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                <input type="checkbox" v-model="editable._foto_validado" class="custom-control-input" id="customSwitch10" @change="changeTipo($event)" :disabled="lock._foto_validado">
                                                <label style="width:70px;" class="custom-control-label" for="customSwitch10" v-html="text._foto_validado"></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <img id="image" width="240" height="288" v-bind:src="'/storage/'+editable.folder+'/2_sin_validar/'+editable.foto"/>
                                        </div>
                                    </div>        
                                </div>
                            </div>
