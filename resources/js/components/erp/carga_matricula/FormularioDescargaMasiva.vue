        ...
        <div class="modal-dialog modal-primary modal-xl">
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label><dt>Codigos de Estudiantes:</dt></label>
                                    <textarea type="text" v-model="editable.codigos" class="form-control" placeholder="codigo 1, codigo 2, codigo 3, codigo 4..." rows="5"></textarea>
                                    <span class="text-error" v-if="errors.codigos">{{errors.codigos}}</span>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" v-if="var_config.tipo_accion=='descargar'" class="btn btn-primary" :disabled="btn.actualizar" @click="descargarPhotos()">Descargar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
