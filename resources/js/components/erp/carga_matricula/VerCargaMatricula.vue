                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr v-for="(error,index) in array_errores" :key="error.id">
...
export default {
    ...
    methods: {
        listarCargaMatricula(page, buscar, criterio){
            let me = this;
            ...
            axios.post('/carga_matricula/id',{
                ...
                me.array_errores = JSON.parse(respuesta.cargas_matriculas.errores);
